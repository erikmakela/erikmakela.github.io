...
---
## What is [Scam baiting](https://en.wikipedia.org/wiki/Scam_baiting)?

 "Scambaiters pose as potential victims to waste the time and resources of gather information useful to authorities, and publicly expose scammers." It is the most fun activity I have ever participated in because you can go ham wild on whatever personality or mayhem you want to make up during a phone call.

## 0. Watch the Possible Fun to [Guage Interest](https://github.com/the-cult-of-integral/Scambaiting-Setup/tree/master)

- [Jim Browning](https://www.youtube.com/channel/UCBNG0osIBAprVcZZ3ic84vw) (Has taken down some of the largest scam operations)
...
## 3. Have tools ready to fake your identity, voice, [etc.](https://www.reddit.com/r/scambait/comments/fgd2l6/setting_up_a_scambait_vm/)

- Scam Baiting Tools: <https://scambaitingtools.com/>
- Fake Identity
  - [Fake Profile Picture](https://thispersondoesnotexist.com/)
...
- Fake Bank Information
  ...
  - <https://help.chargeover.com/article/show/15581-test-credit-card-numbers-and-test-achecheck-bank-account-numbers>
