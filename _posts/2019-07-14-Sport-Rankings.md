...
math: true
mermaid: true
image: assets/2019-07-14-Sport-Rankings.jpg
---
I actually don't watch sports much at all. I like doing the activity rather than watching them.
However, here is my list all sports by watchability from an interactivity, audience experience, and difficulty or easability of making the sport watchable from a production perspective.

#### Categorical Classification Rankings
1. 1v1 or Combatitive
2. Performative (I put this distinction as different execution style sports are a performance rather than pure skill such as with powerlifting. For example Figure Skating,acrobatics > Diving > Weightlifting)
3. Team based sports 
4. Technical sports
4. Racing
...
- Acrobatic Arts - Dacning/Cheerleading/Figure Skating
- Drone Racing
- Gymnastics - Balance beam/Pommel Horse/Horizontal Bar
- Parkour/Freerunning - Ninja Warrior
...
- Polo
- Climbing - Competivie Rock Climbing
- Flying disc sports - Disc Golf/Grisbee
- Sports that use a non-netted racket, or paddle - Table Tenis(Ping Pong) [Faster in nature]
- Sports that use a netted racket - Badmiton/Tennis/Volley Ball
- Cycling - Bicycle
...
#### Backround Noise - Low Watchability
- Mind Sports - Card Games/Rubix Cube/Excel [while they are all highly engaging to play I don't think they're as engaging to watch]
...
- Hunting (morally questional at best)
- Bowling

#### Not Applicable:
- Mixed Disciplines - Triathalon
- Orienteering - Geocashing
- Quidditch - Harry Potter
- Comment: Fighting is combatitive in nature and I would not classify it directly as a sport in this ranking. For example, fencing, sword dueling, or bull-leaping would be in this exception)
