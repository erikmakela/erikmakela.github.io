...
Self-explanatory. I could go into if there were any writers that specifically shared the two series. However, given the fact that Voyager occupied after The Next Generation both chronologically and in release order, the mention of "Warp 13" in the future was before that of warp 10 (the transwarp barrier) being defined in Voyager.
