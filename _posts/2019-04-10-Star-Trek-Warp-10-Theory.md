...
math: true  
mermaid: true
image: assets/2019-04-10-Star-Trek-Warp-10-Theory.jpg
---
...
> It is clear that there is no more warp 5 limit in the future. This limit was set in "Force of Nature". In addition, ships in the future timeline are able to go above Warp 10, up to at least Warp 13. This would appear to contradict "Threshold", where it is stated that Warp 10 is the theoretical limit. It is, however, possible that the warp scale was recalibrated in this future. https://memory-alpha.fandom.com/wiki/Threshold_(episode)
- Stardate: 49373.4 - May 16,  2372, Time: 15:56:44
- Final epsisode "endgame" Stardate: 54973.4 - December 22,  2377, Time: 06:59:02
...
2. Tom Achives Warp 10 (Stardate: 47988 - December 27,  2370, Time: 14:52:48)
...
Self-explanitory. I could go into if there were any writers that specifically shared the two series. However, given the fact that Voyager occuried after The Next Generation both chronologically and in release order, the mention of "Warp 13" in the future was before that of warp 10 (the transwarp barrier) being defined in Voyager.
Without my logical tie in of the timeline it could have been a writing error (as I do not believe that warp speeds were defined anywhere else in other series, hence the creation of this theory).
